...
describe("normalized persistence projection", () => {
  it("projects seeded state into normalized table rows with compliance fields", () => {
    ...
    expect(summary.tables.providerMetricsDaily).toBe(state.providerMetricsDaily.length);
    expect(summary.tables.asyncJobRuns).toBe(state.asyncJobRuns.length);
    expect(summary.tables.jobLogs).toBe(state.jobLogs.length);
    expect(summary.tables.jobIdempotencyRecords).toBe(state.jobIdempotencyRecords.length);
    expect(summary.tables.contacts).toBe(state.contacts.length);
    expect(summary.tables.fieldSources).toBe(state.fieldSources.length);
    ...
    expect(summary.tables.providerCache).toBe(state.providerCache.length);
    ...
    expect(summary.tables.dedupeMatches).toBe(state.dedupeMatches.length);
    ...
    expect(summary.tables.exportRules).toBe(state.exportRules.length);
    ...
    expect(summary.tables.webhookEvents).toBe(state.webhookEvents.length);
    ...
    expect(summary.tables.waterfallTemplates).toBe(state.waterfallTemplates.length);
